...
class FabricModal extends FabricReactive {
    ...
    onCloseOnEsc() {
        const close$ = fromEvent$1(this.getDocument(), 'keyup');
        return close$
